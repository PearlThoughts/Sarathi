...
**YOU ARE IN: `Sarathi/polecats/capable/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/Sarathi/` (rig root) or other directories
...
**Your mail address:** `Sarathi/polecats/capable`
**Your rig:** Sarathi
**Your Witness:** `Sarathi/witness`
...
| Ask Witness for help | `gt mail send Sarathi/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`Sarathi/witness`) when:
...
```bash
gt mail send Sarathi/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
