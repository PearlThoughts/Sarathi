...
- [ ] Add bounded concurrency, lease renewal, and load evidence.
- [ ] Add and prove private-channel installation, consent, membership, and corpus isolation.
- [ ] Keep shared channels disabled until separately approved.
- [ ] Re-run governed report regressions and complete evaluation.
- [ ] Capture exact-answer human ratings only after authorized review.
- [ ] Exercise disable and rollback paths.
