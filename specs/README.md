...
Current status: structured capability-first delivery reporting and strict report composition failure handling are implemented. Collaboration-scope availability remains governed by specification 006 and ADR 0010. The Product Capability Registry and Product Studio are proposed contracts, not implemented availability claims.
