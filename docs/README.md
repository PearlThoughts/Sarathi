...
- [Local Product Registry And Product Studio](local-product-registry.md) documents isolated PostgreSQL services, governed proposal import, verification, and the production approval gate.
...
- [Response Feedback](answer-feedback.md) defines per-answer Teams feedback, durable revisions, privacy-safe metrics, and the review-before-training boundary.
...
- [ADR 0013](adr/0013-delivery-execution-observability.md) records privacy-safe delivery execution observability, one absolute deadline, cooperative cancellation, fail-open OTLP export, and collector ownership.
